...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.gen_db=False # Only True when we use posterior model to generate belief state.
        ...
        self.freeze_infer=False # freeze the inference model
        #STtrain:
        self.straight=True # whether add straight through trick
        self.ST_resp_only=True #whether calculate cross-entropy on response only
        self.ST_with_infer=False # self training with inference model
        #evaluation:
        ...
        self.back_translation=False # data augmentation with back translation
